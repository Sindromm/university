...
//Date        : Wed Nov 15 04:37:58 2017
//Host        : Berserk-ой running 64-bit Service Pack 1  (build 7601)
...
module local_memory_imp_1OXRTFC
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > uc_system local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
...
module uc_system
  ...
  uc_system_microblaze_0_axi_periph_1 axi_interconnect
  ...
  uc_system_clk_wiz_0_0 clk_wiz
       (.clk_in1(clock_rtl_1),
        ...
        .reset(reset_rtl_1));
  local_memory_imp_1OXRTFC local_memory
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > uc_system local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  uc_system_proc_sys_reset_0_0 proc_sys_reset
       (.aux_reset_in(1'b1),
...
module uc_system_microblaze_0_axi_periph_1
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
